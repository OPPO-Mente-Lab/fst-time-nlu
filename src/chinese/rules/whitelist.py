...
class WhitelistRule(Processor):
    ...
    def build_tagger(self):
        ...
        tagger = (
            ...
            + (
                ...
                | hao_pattern
                | num_measure_pattern
                | decimal_measure_pattern
                | num_range_pattern
                | comparison_hour_pattern
                | three_digit_hao_pattern
                | am_pm_with_letter_pattern
                | anti_noon
            )
        ) + insert('"')
    ...
    def _build_num_range_pattern(self):
        ...
        pattern1 = (
            three_plus_digit + separator + any_number | any_number + separator + three_plus_digit
        )
    ...
    def _build_three_digit_hao_pattern(self):
        ...
        # 40-99: [4-9][0-9]
        num_40_99 = (
            accep("4") | accep("5") | accep("6") | accep("7") | accep("8") | accep("9")
        ) + arabic_digit
